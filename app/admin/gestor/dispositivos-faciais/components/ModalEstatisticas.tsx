...
export function ModalEstatisticas({
  ...
  const titulo = `Estatisticas - ${dispositivo.nome}`

  return (
    <ModalBase aberto onFechar={onClose} titulo={titulo} largura="2xl">
      <div className="space-y-6">
        {/* Subtitulo (escola) — o titulo principal e usado no header
            estruturado do ModalBase; aqui complementamos com a escola. */}
        <p className="-mt-2 text-sm text-gray-500 dark:text-gray-400">{dispositivo.escola_nome}</p>
