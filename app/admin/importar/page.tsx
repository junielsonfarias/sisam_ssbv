          ...
          <div className="bg-white dark:bg-slate-800 rounded-lg shadow-md p-6">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mb-4">
                Selecione um arquivo Excel (.xlsx ou .xls) com os dados das provas.
              ...
              <div className="mb-6 space-y-4">
                ...
                {resultado.colunas_detectadas && (
                  <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                    <p className="font-semibold text-blue-800 mb-2">Colunas Detectadas:</p>
                    <div className="grid grid-cols-2 md:grid-cols-3 gap-2 text-sm">
                      {Object.entries(resultado.colunas_detectadas).map(([key, value]: [string, any]) => (
                        <div key={key}>
              ...
              <div className="flex items-start">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <ul className="list-disc list-inside space-y-1">
                    ...
                    <li>Certifique-se de que as colunas estão na ordem correta</li>
                    <li>Verifique se todos os dados obrigatórios estão preenchidos</li>
                    <li>A importação pode levar alguns minutos dependendo do tamanho do arquivo</li>
                  </ul>
                </div>
              </div>
            </div>
