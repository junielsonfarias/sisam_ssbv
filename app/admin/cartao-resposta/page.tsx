            ...
            <div className="mt-4 sm:mt-6 bg-white rounded-lg shadow-md p-4 sm:p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-3 sm:mb-4">
                <div className="bg-blue-50 p-3 sm:p-4 rounded-lg">
                  <p className="text-xs sm:text-sm text-gray-600">Total de Questões</p>
                  <p className="text-xl sm:text-2xl font-bold text-blue-600">{resultado.total_questoes}</p>
                </div>
                <div className="bg-green-50 p-3 sm:p-4 rounded-lg">
                  <p className="text-xs sm:text-sm text-gray-600">Respostas Detectadas</p>
                  <p className="text-xl sm:text-2xl font-bold text-green-600">{resultado.respostas_detectadas}</p>
                </div>
                <div className="bg-yellow-50 p-3 sm:p-4 rounded-lg">
                  <p className="text-xs sm:text-sm text-gray-600">Taxa de Sucesso</p>
                ...
                <div className="mt-3 sm:mt-4">
                  ...
                  <div className="grid grid-cols-4 sm:grid-cols-5 md:grid-cols-10 gap-1.5 sm:gap-2 max-h-64 sm:max-h-96 overflow-y-auto">
                    {Object.entries(resultado.respostas).map(([questao, alternativa]: any) => (
                      <div key={questao} className="bg-gray-50 p-1.5 sm:p-2 rounded text-center border border-gray-200">
