...
import { RelatorioEscolaWeb } from '@/components/relatorios/RelatorioEscolaWeb';
...
export default function RelatorioEscolaPage() {
  ...
  const [dados, setDados] = useState<DadosRelatorioEscola | null>(null);
  ...
  useEffect(() => {
    async function carregarDados() {
      ...
      try {
        ...
        const response = await fetch(`/api/admin/relatorios/escola/${escolaId}/dados?${queryParams}`);
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">
            Buscando dados da escola para o ano {anoLetivo}
            {serie && ` - ${serie}`}
          </p>
        </div>
      </div>
      ...
      <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-slate-900 p-4">
        <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-lg shadow-lg p-6 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-300 mb-6">
            Não foram encontrados dados para esta escola no ano letivo {anoLetivo}.
          </p>
          <Link
            href="/admin/relatorios"
    ...
    <>
      ...
      <main className="min-h-screen bg-gray-50 dark:bg-slate-900 py-6 print:bg-white print:py-0">
        <div ref={containerRef}>
          <RelatorioEscolaWeb dados={dados} />
        </div>
      </main>
