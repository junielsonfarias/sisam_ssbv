...
import { School, MapPin, BarChart3, GraduationCap, TrendingUp, CheckCircle, XCircle, BookOpen, Users } from 'lucide-react'
    ...
    <ProtectedRoute tiposPermitidos={['administrador', 'tecnico']}>
      <LayoutDashboard tipoUsuario="admin">
        <div className="p-3 sm:p-4 md:p-6">
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-800 dark:text-white mb-4 sm:mb-6 md:mb-8">Dashboard Administrativo</h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-6 sm:mb-8">
            ...
            <div className="bg-white dark:bg-slate-800 p-4 sm:p-6 rounded-lg shadow-md dark:shadow-slate-900/50 border-l-4 border-blue-500">
              <div className="flex items-center justify-between">
                ...
                <MapPin className="w-10 h-10 sm:w-12 sm:h-12 text-blue-600 dark:text-blue-400 flex-shrink-0 ml-2" />
              </div>
            </div>
