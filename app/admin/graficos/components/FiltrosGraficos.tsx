...
import { FiltrosGraficos as FiltrosGraficosType } from './types'

interface FiltrosGraficosProps {
  filtros: FiltrosGraficosType
  tipoVisualizacao: string
  setTipoVisualizacao: (v: string) => void
  handleFiltroChange: (campo: keyof FiltrosGraficosType, valor: string) => void
  limparFiltros: () => void
...
export default function FiltrosGraficosComponent({
  filtros,
  tipoVisualizacao,
  setTipoVisualizacao,
  handleFiltroChange,
