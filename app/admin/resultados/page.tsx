                ...
                <div className="hidden sm:block w-full h-full">
                  <table className="w-full divide-y divide-gray-200 dark:divide-slate-700 min-w-[600px] md:min-w-[800px] lg:min-w-[900px] xl:min-w-[1100px]">
                    <thead className="bg-gradient-to-r from-indigo-50 to-indigo-100 sticky top-0 z-20">
                        <tr>
                          <th className="text-center py-1 px-0.5 sm:py-1.5 sm:px-1 md:py-2 md:px-1.5 lg:py-2.5 lg:px-2 font-bold text-indigo-900 text-[11px] sm:text-xs md:text-xs lg:text-sm uppercase tracking-wider border-b border-indigo-200 w-8 md:w-10 lg:w-12">
                            #
                          </th>
                          <th className="text-left py-1 px-0.5 sm:py-1.5 sm:px-1 md:py-2 md:px-1 lg:py-2.5 lg:px-2 font-bold text-indigo-900 text-[11px] sm:text-xs md:text-xs lg:text-sm uppercase tracking-wider border-b border-indigo-200 min-w-[120px] md:min-w-[140px] lg:min-w-[160px]">
                            Aluno
                          </th>
                          ...
                          {disciplinasExibir.map((disciplina) => (
                            <th key={disciplina.codigo} className="text-center py-1 px-0 sm:py-1.5 sm:px-0.5 md:py-2 md:px-1 lg:py-2.5 lg:px-1.5 font-bold text-indigo-900 text-[11px] sm:text-xs md:text-xs lg:text-sm uppercase tracking-wider border-b border-indigo-200 w-14 md:w-16 lg:w-18">
                              {disciplina.codigo}
                            </th>
                          ))}
                          <th className="text-center py-1 px-0 sm:py-1.5 sm:px-0.5 md:py-2 md:px-1 lg:py-2.5 lg:px-1.5 font-bold text-indigo-900 text-[11px] sm:text-xs md:text-xs lg:text-sm uppercase tracking-wider border-b border-indigo-200 w-14 md:w-16 lg:w-18">
                            Média
                          </th>
                          <th className="text-center py-1 px-0.5 sm:py-1.5 sm:px-1 md:py-2 md:px-1.5 lg:py-2.5 lg:px-2 font-bold text-indigo-900 text-[11px] sm:text-xs md:text-xs lg:text-sm uppercase tracking-wider border-b border-indigo-200 w-16 md:w-20 lg:w-24">
                            Ações
                          </th>
                        </tr>
                      </thead>
          ...
          {(resultadosFiltrados.length > 0 || estatisticas.total > 0) && (
            <div className={`bg-indigo-50 border border-indigo-200 rounded-xl p-4 ${carregando ? 'opacity-50' : ''}`}>
              <div className="flex flex-col gap-3">
                {/* Linha 1: Total e Legenda de Desempenho */}
                ...
                {/* Linha 2: Legenda de Níveis (Anos Iniciais) */}
                <div className="border-t border-indigo-200 pt-3">
                  <p className="text-xs font-semibold text-indigo-800 mb-2">Critérios de Avaliação por Nível (Anos Iniciais - 2º, 3º e 5º Ano):</p>
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-2 text-[10px] sm:text-xs">
                    <div className="flex items-start gap-1">
                      <span className="inline-flex items-center justify-center px-1.5 py-0.5 rounded-full font-bold bg-red-100 text-red-700 text-[9px]">N1</span>
                      <span className="text-gray-700">Crítico: LP/MAT 1-3 acertos (2º/3º/5º); 5º MAT 1-5</span>
                    </div>
                    <div className="flex items-start gap-1">
                      <span className="inline-flex items-center justify-center px-1.5 py-0.5 rounded-full font-bold bg-yellow-100 text-yellow-700 text-[9px]">N2</span>
                      <span className="text-gray-700">Básico: LP/MAT 4-7 acertos (2º/3º/5º); 5º MAT 6-10</span>
                    </div>
                    <div className="flex items-start gap-1">
                      <span className="inline-flex items-center justify-center px-1.5 py-0.5 rounded-full font-bold bg-blue-100 text-blue-700 text-[9px]">N3</span>
                      <span className="text-gray-700">Adequado: LP/MAT 8-11 acertos (2º/3º/5º); 5º MAT 11-15</span>
                    </div>
                    <div className="flex items-start gap-1">
                      <span className="inline-flex items-center justify-center px-1.5 py-0.5 rounded-full font-bold bg-green-100 text-green-700 text-[9px]">N4</span>
                      <span className="text-gray-700">Avançado: LP/MAT 12+ acertos (2º/3º/5º); 5º MAT 16+</span>
                    </div>
                  </div>
                  <p className="text-[10px] text-gray-500 mt-1">* PROD: Nível convertido da avaliação textual (Insuficiente→N1, Básico→N2, Adequado→N3, Avançado→N4). Nível Geral = média dos 3 níveis.</p>
                </div>
              </div>
            </div>
          )}
