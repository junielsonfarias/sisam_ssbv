...
function DiarioTurmaProfessorContent() {
  ...
  return (
    <div className="space-y-6">
      <Link href="/professor/turmas" className="inline-flex items-center gap-2 text-sm text-gray-500 hover:text-emerald-600 dark:hover:text-emerald-400 transition">
        ...
        <div className="flex flex-wrap items-start justify-between gap-3">
          ...
          <div className="flex flex-wrap gap-2 shrink-0">
            <button
              ...
              className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-emerald-600 hover:bg-emerald-700 active:bg-emerald-800 text-white text-sm font-medium rounded-lg shadow-sm transition"
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-3 sm:px-4 py-2 bg-indigo-600 hover:bg-indigo-700 active:bg-indigo-800 disabled:opacity-60 disabled:cursor-not-allowed text-white text-sm font-medium rounded-lg shadow-sm transition"
          ...
          <div className="mt-4 pt-4 border-t border-gray-100 dark:border-slate-700">
            ...
            <div className="flex flex-wrap gap-2">
              {professores.map(p => (
                <span
                  key={p.vinculo_id}
                  className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 text-xs rounded-full"
...
export default function DiarioTurmaProfessorPage() {
  return (
    <ProtectedRoute tiposPermitidos={['professor']}>
      <DiarioTurmaProfessorContent />
    </ProtectedRoute>
  )
}
