      ...
      <LayoutDashboard tipoUsuario="polo">
        <div className="p-3 sm:p-4 md:p-6">
          <div className="mb-4 sm:mb-6 md:mb-8">
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-800">Dashboard do Polo</h1>
            {estatisticas.nomePolo && (
              <p className="text-gray-600 mt-1 text-sm sm:text-base">Polo: {estatisticas.nomePolo}</p>
            )}
          </div>
