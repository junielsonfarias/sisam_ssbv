...
COMMENT ON VIEW resultados_consolidados_v2 IS
  'VIEW que calcula dados consolidados dinamicamente considerando a estrutura de questoes por serie. Anos iniciais (2,3,5): LP=Q1-Q14, MAT varia. Anos finais (6-9): LP=Q1-Q20, CH=Q21-Q30, MAT=Q31-Q50, CN=Q51-Q60.';

COMMENT ON VIEW resultados_consolidados_unificada IS
  'VIEW unificada que usa resultados_consolidados_v2 quando disponivel, ou resultados_consolidados como fallback. Prioriza dados calculados dinamicamente.';
