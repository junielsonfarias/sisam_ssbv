...
export default function PainelDados({
  ...
  // Carregar escolas quando mudar para aba escolas
  useEffect(() => {
    if (abaAtiva === 'escolas' && escolasEndpoint) {
      carregarEscolas()
    }
  }, [abaAtiva, escolasEndpoint])

  // Carregar turmas quando mudar para aba turmas
  useEffect(() => {
    if (abaAtiva === 'turmas' && turmasEndpoint) {
      carregarTurmas()
    }
