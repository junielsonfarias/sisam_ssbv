...
function AbaGeral({ estatisticas, tipoUsuario, carregando, serieSelecionada, mediaGeralCalculada }: {
...
function AbaAnalises({ estatisticas, carregando, serieSelecionada, mediaGeralCalculada }: {
  estatisticas: Estatisticas;
  carregando: boolean;
  serieSelecionada?: string;
  mediaGeralCalculada: number;
