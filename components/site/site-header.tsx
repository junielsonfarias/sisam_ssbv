...
export default function SiteHeader({ data }: SiteHeaderProps) {
  ...
  return (
    ...
    >
      ...
      <div className={`bg-blue-900 text-white text-center transition-all duration-500 ${scrolled ? 'py-1 text-[10px] sm:text-xs' : 'py-1.5 text-[11px] sm:text-sm'} font-semibold tracking-wide`}>
