  ...
  return (
    <footer className="bg-slate-900 text-slate-300" role="contentinfo">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-16 lg:py-20">
        {/* Mobile: layout compacto em 1 coluna */}
        {/* Desktop: 3 colunas como antes */}
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 lg:gap-16">
          ...
          <div>
            ...
            {/* Redes sociais + Portal do Educador na mesma linha no mobile */}
            <div className="flex items-center gap-3 flex-wrap">
              {data?.facebook_url && (
                <a href={data.facebook_url} target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-white/10 flex items-center justify-center text-slate-400 hover:bg-[#1877F2] hover:text-white transition-all" title="Facebook">
              ...
              {data?.instagram_url && (
                <a href={data.instagram_url} target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-white/10 flex items-center justify-center text-slate-400 hover:bg-[#E4405F] hover:text-white transition-all" title="Instagram">
              ...
              {data?.youtube_url && (
                <a href={data.youtube_url} target="_blank" rel="noopener noreferrer" className="w-8 h-8 sm:w-9 sm:h-9 rounded-full bg-white/10 flex items-center justify-center text-slate-400 hover:bg-[#FF0000] hover:text-white transition-all" title="YouTube">
              ...
              <Link
                href="/login"
                className="inline-flex items-center gap-1.5 px-3 sm:px-5 py-1.5 sm:py-2.5 rounded-full text-xs sm:text-sm font-bold bg-blue-800/10 border border-blue-700/20 text-blue-400 hover:bg-blue-800/20 hover:text-blue-300 transition-all duration-300"
              >
                Portal do Educador
          ...
          {/* Column 2: Links — oculto no mobile (menu já tem) */}
          ...
          <div>
            <h4 className="text-xs sm:text-sm font-bold text-white uppercase tracking-wider mb-3 sm:mb-5">
              Contato
            </h4>
            <ul className="space-y-2 sm:space-y-3">
              <li className="flex items-start gap-2 text-xs sm:text-sm text-slate-400">
