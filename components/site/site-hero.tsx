...
export default function SiteHero({ data }: SiteHeroProps) {
  ...
  const ctaPrimary = data?.ctaPrimary || { label: 'Acessar o Portal', href: '/login' }
  ...
  return (
    <section className="relative sm:min-h-screen flex items-center overflow-hidden bg-gradient-to-b from-blue-50/60 to-white pt-32 sm:pt-28 lg:pt-24" aria-label="Seção principal">
      {/* Subtle dot pattern */}
