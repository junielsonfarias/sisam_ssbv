        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service: any, i: number) => {
            ...
            return (
              <div
                key={i}
                className="group relative bg-white rounded-2xl p-8 border border-slate-100 hover:border-emerald-200 hover:shadow-lg hover:shadow-emerald-500/5 transition-all duration-300 hover:-translate-y-1"
              >
                {/* Icon in colored circle */}
                <div className="w-14 h-14 rounded-full bg-emerald-50 border border-emerald-100 flex items-center justify-center mb-6 group-hover:bg-emerald-600 group-hover:border-emerald-600 group-hover:shadow-lg group-hover:shadow-emerald-600/25 transition-all duration-300">
