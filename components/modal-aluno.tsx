        ...
        <div className="inline-block align-bottom bg-white dark:bg-slate-800 rounded-lg text-left overflow-hidden shadow-xl dark:shadow-slate-900/50 transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl w-full mx-3 sm:mx-0">
          <div className="bg-white dark:bg-slate-800 px-4 sm:px-6 py-4">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={onClose} className="text-gray-400 hover:text-gray-500 dark:hover:text-gray-300 p-1" aria-label="Fechar modal">
            ...
            <div className="space-y-3 sm:space-y-4 max-h-[calc(100vh-200px)] overflow-y-auto">
              ...
              <label htmlFor="pcd-checkbox" className="flex items-center gap-2 min-h-[44px] cursor-pointer">
                <input
                  type="checkbox"
                  id="pcd-checkbox"
                  checked={formData.pcd || false}
                  onChange={(e) => setFormData({ ...formData, pcd: e.target.checked })}
                  className="w-5 h-5 text-indigo-600 border-gray-300 dark:border-slate-600 rounded focus:ring-indigo-500 dark:bg-slate-700"
                />
