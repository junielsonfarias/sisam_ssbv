...
> Ultima atualizacao: 2026-05-31 (Sessao roadmap pos-auditoria + ajuste facial->diario: 27 commits, 5 frentes + propagacao facial para frequencia_hora_aula em anos finais)
...
| Metrica | Valor |
|---------|-------|
| **Total de horas** | **335.5h** |
| **Dias trabalhados** | 43 |
| **Media por dia** | 7.8h |
| **Periodo** | 31/12/2025 — 31/05/2026 |
| **Total de commits** | 761 |
| **Linhas de codigo** | 84.500+ (app/components/lib/database) |
| **Arquivos TS/TSX** | 1.045 |
| **Endpoints API** | 180+ (admin) + outros |
| **Testes** | 736 (1 timezone pre-existente) |
...
**Subtotal Mai/2026: 39.5h | 5 dias | 121 commits**
